...
;*                  09/2025 uprava pto registry BSRR, BRR
;********************************************************************************
;--------------------------------------------------------------------------------
;* Poznamky GPIO
;* dulezité registry , definovány nize, zde jen pro prehled

;* GPIOA_CRL			EQU		0x40010800
;* GPIOA_CRH	 		EQU		0x40010804
;* GPIOA_ODR	 		EQU		0x4001080C ; output data registr A
;* GPIOA_BSRR	 		EQU		0x40010810
;* GPIOA_BRR	 		EQU		0x40010814
;* GPIOA_IDR	 		EQU		0x40010808 ; input data registr A
;* 
;--------------------------------------------------------------------------------
;--------------------------------------------------------------------------------
;* GPIOB_CRL			EQU		0x40010C00
;* GPIOB_CRH	 		EQU		0x40010C04
;* GPIOB_ODR	 		EQU		0x40010C0C ; output data registr B
;* GPIOB_BSRR	 		EQU		0x40010C10
;* GPIOB_BRR	 		EQU		0x40010C14
;* GPIOB_IDR	 		EQU		0x40010C08 ; input data registr B
;--------------------------------------------------------------------------------
;--------------------------------------------------------------------------------
...
;* GPIOC_ODR	 		EQU		0x4001100C ; output data registr C
;* GPIOC_BSRR	 		EQU		0x40011010
;* GPIOC_BRR	 		EQU		0x40011014
;* GPIOC_IDR	 		EQU		0x40011008 ; input data registr C
;--------------------------------------------------------------------------------
;*
...
GPIOB_CRH	 		EQU		0x40010C04
;--------------------------------------------------------------------------------
GPIOB_IDR	 		EQU		0x40010C08 ; input data registr
;GPIOB_IDR	bits
...
FLASH_KEYR			EQU		0x40022004	; Flash key register
FLASH_OPTKEYR		EQU 	0x40022008 	;Option key register
FLASH_SR			EQU 	0x4002200C	;Status register
FLASH_CR			EQU		0x40022010	;Control register
FLASH_AR			EQU		0x40022014	;Address register
FLASH_OBR			EQU		0x4002201C	; Option byte register
FLASH_WRPR			EQU		0x40022020	; Write protection register
;--------------------------------------------------------------------------------
;FLASH Key values
;--------------------------------------------------------------------------------
FLASH_RDPRT			EQU		0x00A5
...
; doplnky 9/2025
;jsou definovany masky pro nulovani bitu v konf. registru a definovany bity pro registr Reset a registr SET reset.


Mode_in_float			EQU		2_0100
Mode_in_pull_up  		EQU		2_1000    ; jeste se pak musí zapsat "1" do prisl. bitu ODR
Mode_out_pp				EQU		2_0001
Mode_out_od				EQU		2_0101
Maska_k0				EQU     (2_1111 :SHL: 0x0)
Maska_k1	 			EQU		(2_1111 :SHL: 0x4)
Maska_k2	 			EQU		(2_1111 :SHL: 0x8)
Maska_k3	 			EQU		(2_1111 :SHL: 0xC)
Maska_k4	 			EQU		(2_1111 :SHL: 0x10)
Maska_k5	 			EQU		(2_1111 :SHL: 0x14)
Maska_k6	 			EQU		(2_1111 :SHL: 0x18)
Maska_k7	 			EQU		(2_1111 :SHL: 0x1C)
	
	
	
	
; toto lze vyuzit pro tvorbu konstanty pri testovani stavu tlacitka
